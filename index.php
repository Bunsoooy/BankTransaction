...
<body>
<div class="container">
    <h1 class="text-center mb-4">Bank Transaction</h1>
    <div class="row">
        <div class="col-md-6">
            <h2>Sender</h2>
                <div class="mb-3">
                    ...
                    <button class="btn btn-outline-secondary" type="button" id="toggleSenderBalance">
...
<script>
    document.getElementById('toggleSenderBalance').addEventListener('click', function() {
        var senderBalanceInput = document.getElementById('sender_balance');
        var toggleIcon = document.getElementById('toggleIcon');

        if (senderBalanceInput.type === 'text') {
            senderBalanceInput.type = 'password';
            toggleIcon.classList.remove('fa-eye');
            toggleIcon.classList.add('fa-eye-slash');
        } else {
            senderBalanceInput.type = 'text';
